...
- (instancetype)initWithSelectedAssets:(NSMutableArray *)selectedAssets selectedPhotos:(NSMutableArray <TYimageModel *>*)selectedPhotos index:(NSInteger)index{
    TZPhotoPreviewController *previewVc = [[TZPhotoPreviewController alloc] init];
    previewVc.tzPhotoType = TZPHOTOPREVIEWHAVEDEL;
    ...
    if (self) {
        ...
        [previewVc setDoneButtonClickBlockWithPreviewType:^(NSArray<TYimageModel *> *photos, NSArray *assets, BOOL isSelectOriginalPhoto) {
...
- (void)setSelectedAssets:(NSMutableArray *)selectedAssets {
    ...
    for (TYImageAssetModel * assetModel in selectedAssets) {
        TZAssetModel *model = [TZAssetModel modelWithAsset:assetModel.asset type:TZAssetModelMediaTypePhoto];
        model.imageUrl = assetModel.imageUrl;
