...
- (void)setUpScrollViewContent{
    ...
    for (NSInteger i=0; i<self.imagesGroup.count; i++) {
        ZSScrollViewCell *cell = [[ZSScrollViewCell alloc] initWithFrame:CGRectMake(self.scrollView.width*(i+1), 0, self.scrollView.width, 200)];
    ...
    if (self.imagesGroup.count) {
        ...
        ZSScrollViewCell *first = [[ZSScrollViewCell alloc] initWithFrame:CGRectMake(0, 0, self.scrollView.width, 200)];
        ...
        ZSScrollViewCell *last = [[ZSScrollViewCell alloc] initWithFrame:CGRectMake(self.scrollView.width*(self.imagesGroup.count+1), 0, self.scrollView.width, 200)];
...
- (void)layoutSubviews{
    ...
    CGFloat pageControllY = 200 - size.height - 16;
