...
@protocol ZSPageControlDelegate;
 ...
 */
@property(nonatomic,assign) id<ZSPageControlDelegate> delegate;
...
@optional
- (void)ZSPageControl:(ZSPageControl
                       *)pageControl didSelectPageAtIndex:(NSInteger)index;
