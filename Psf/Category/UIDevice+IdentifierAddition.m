...
//    BEA19941-D9F5-4B2C-802C-017116A59662;
    if (udid.length==0) {
        udid = [self uuid];
...
- (NSString *)machineType
{
    ...
    if ([machineType isEqualToString:@"iPhone3,1"])    return @"iPhone 4 (GSM)";
    if ([machineType isEqualToString:@"iPhone3,3"])    return @"iPhone 4 (CDMA)";
    ...
    if ([machineType isEqualToString:@"iPad4,4"])      return @"iPad Mini wifi";
    if ([machineType isEqualToString:@"iPad4,5"])      return @"iPad Mini Cellular";
    if ([machineType isEqualToString:@"iPhone7,2"])    return @"iPhone 6 Plus";
    if ([machineType isEqualToString:@"iPhone8,2"])    return @"iPhone 6S Plus";
    if ([machineType isEqualToString:@"iPhone7,1"])    return @"iPhone 6";
