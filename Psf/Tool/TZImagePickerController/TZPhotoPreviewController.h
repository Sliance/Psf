...
typedef NS_ENUM(NSInteger, TZPHOTOPREVIEWTYPE) {
    TZPHOTOPREVIEWNOTHAVEDEL,
    TZPHOTOPREVIEWHAVEDEL
};
...
@property (nonatomic, strong) NSMutableArray <TYimageModel *>*photos;                  ///< All photos  / 所有图片数组
...
@property (nonatomic, assign) TZPHOTOPREVIEWTYPE tzPhotoType;
...
@property (nonatomic, copy) void (^doneButtonClickBlockWithPreviewType)(NSArray<TYimageModel *> *photos,NSArray *assets,BOOL isSelectOriginalPhoto);
