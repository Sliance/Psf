...
+ (void)requestReturnStrWithUrlString:(NSString *)urlString parameters:(id)parameters succeed:(void(^)(id data))succeed fail:(void(^)(NSError *error))fail{
    [self requestRetuenStrType:NetworkRequestTypeGET url:urlString parameters:parameters succeed:succeed fail:fail];
}
...
/**
 ...
 @param fail 失败的回调
 */
+ (void)requestRetuenStrType:(NetworkRequestType)type url:(NSString *)urlString parameters:(id)parameters succeed:(void(^)(id data))succeed fail:(void(^)(NSError *error))fail{
