        ...
        if (model.imageUrl) {
            if (model.imageUrl.length < 7) {
                [[TZImageManager manager] getPhotoWithAsset:model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
                    ...
                    [assets replaceObjectAtIndex:i withObject:assetModel];
...
//                [photos replaceObjectAtIndex:i withObject:[UIImage imageNamed:@""]];
                if ([model.asset isKindOfClass:[PHAsset class]]) {
                    TYImageAssetModel * assetModel = [[TYImageAssetModel alloc] init];
                    assetModel.asset = model.asset;
                    assetModel.imageUrl = model.imageUrl;
                    [assets replaceObjectAtIndex:i withObject:assetModel];
                }else{
                    TYImageAssetModel * assetModel = [[TYImageAssetModel alloc] init];
                    assetModel.imageUrl = model.imageUrl;
...
- (void)didGetAllPhotos:(NSArray *)photos assets:(NSArray <TYImageAssetModel *>*)assets infoArr:(NSArray *)infoArr {
...
- (void)callDelegateMethodWithPhotos:(NSArray *)photos assets:(NSArray <TYImageAssetModel *>*)assets infoArr:(NSArray *)infoArr {
    TZImagePickerController *tzImagePickerVc = (TZImagePickerController *)self.navigationController;
